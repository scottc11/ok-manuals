...
// Declare global Instagram embed variable for TypeScript
declare global {
    interface Window {
        instgrm?: any;
    }
...
const InstagramPostEmbedded: React.FC<InstagramPostEmbeddedProps> = ({ 
    permalink, 
    className = '' 
}) => {
    useEffect(() => {
...
export default InstagramPostEmbedded; 